 ...
 *
 * Disassembly of /Volumes/Macintosh HD/Hackintosh/OEM ACPI Tables/SSDT-3.aml, Mon Oct 25 12:56:22 2021
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000037A5 (14245)
 *     Revision         0x02
 *     Checksum         0xD9
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    OperationRegion (SANV, SystemMemory, 0x9BA83D18, 0x01F4)
    ...
    Scope (\_SB.PCI0.GFX0)
    {
        ...
        Device (DD1F)
        {
            ...
            {
                If (((OSYS == 0x03E8) || (OSYS == 0x03E9)))
                {
                    Return (SUBR) /* \_SB_.PCI0.GFX0.DD1F.SUBR */
                }
                ElseIf ((OSYS < 0x07DC))
                {
                    PLD0 = DerefOf (GC1L [0x02])
                    PLD1 = DerefOf (GC1L [0x03])
                    PLD2 = DerefOf (GC1L [0x04])
                    PLD3 = DerefOf (GC1L [0x05])
                    PLD4 = DerefOf (GC1L [0x06])
                    PLD5 = DerefOf (GC1L [0x07])
                    PLD6 = DerefOf (GC1L [0x08])
                    PLD7 = DerefOf (GC1L [0x09])
                    PLD8 = DerefOf (GC1L [0x0A])
            ...
            Method (BRUP, 0, NotSerialized)
            {
                ...
                If ((Local0 < (PLD1 - 0x03)))
                {
                    Local1 = PLD1 /* \_SB_.PCI0.GFX0.DD1F.PLD1 */
                }
                ElseIf ((Local0 < (PLD2 - 0x03)))
                {
                    Local1 = PLD2 /* \_SB_.PCI0.GFX0.DD1F.PLD2 */
                }
                ElseIf ((Local0 < (PLD3 - 0x03)))
                {
                    Local1 = PLD3 /* \_SB_.PCI0.GFX0.DD1F.PLD3 */
                }
                ElseIf ((Local0 < (PLD4 - 0x03)))
                {
                    Local1 = PLD4 /* \_SB_.PCI0.GFX0.DD1F.PLD4 */
                }
                ElseIf ((Local0 < (PLD5 - 0x03)))
                {
                    Local1 = PLD5 /* \_SB_.PCI0.GFX0.DD1F.PLD5 */
                }
                ElseIf ((Local0 < (PLD6 - 0x03)))
                {
                    Local1 = PLD6 /* \_SB_.PCI0.GFX0.DD1F.PLD6 */
                }
                ElseIf ((Local0 < (PLD7 - 0x03)))
                {
                    Local1 = PLD7 /* \_SB_.PCI0.GFX0.DD1F.PLD7 */
                }
                Else
                {
                    Local1 = PLD8 /* \_SB_.PCI0.GFX0.DD1F.PLD8 */
                }
            ...
            Method (BRDN, 0, NotSerialized)
            {
                ...
                ElseIf ((Local0 > (PLD1 + 0x03)))
                {
                    Local1 = PLD1 /* \_SB_.PCI0.GFX0.DD1F.PLD1 */
                }
                Else
                {
                    Local1 = PLD0 /* \_SB_.PCI0.GFX0.DD1F.PLD0 */
                }
            ...
            {
                Local0 = (0xFF & CBLV) /* \_SB_.PCI0.GFX0.CBLV */
                If ((Local0 <= PLD0))
                {
                    Local1 = One
                }
